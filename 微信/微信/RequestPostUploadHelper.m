...
//  仿微信
//
//  Created by ZHOUQING on 10/19/14.
//  Copyright (c) 2014 zhq. All rights reserved.
//

#import "RequestPostUploadHelper.h"

@implementation RequestPostUploadHelper
static NSString * const FORM_FLE_INPUT = @"upfile";
+ (NSString *)posttRequestWithURL: (NSString *)url  // IN
                     ...
                     picFileName: (NSString *)picFileName;  // IN
{
    ...
    if(picFilePath){
        ...
        image=[self imageWithImageSimple:image scaledToSize:CGSizeMake(49, 49)];
        //判断图片是不是png格式的文件
